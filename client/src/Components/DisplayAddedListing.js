...
export default function DisplayAddedListing({submittedListings}) {
    ...
    const {title,description,category,image,other_Images,price,inclusives,amenities,rules,bathrooms,beds,capacity, location,host} = submittedListings
    //capture inclusives
